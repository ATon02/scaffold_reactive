...
public abstract class TemplateAdapterOperations<E, K, V> {
     ...
     *           due to the low performance resulting
     *           from the design of the database engine (Key value). Optimize the
     *           query using Query, GetItem or BatchGetItem
     *           functions, and if necessary, consider the Single-Table Design
