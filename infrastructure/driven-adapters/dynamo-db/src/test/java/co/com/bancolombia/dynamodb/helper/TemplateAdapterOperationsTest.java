...
class TemplateAdapterOperationsTest {
         ...
         * 
         * when(dynamoDbEnhancedAsyncClient.table("table_name",
         * TableSchema.fromBean(ModelEntity.class)))
         ...
         * @Test
         * void testSave() {
         * when(customerTable.putItem(modelEntity)).thenReturn(CompletableFuture.
         * runAsync(()->{}));
